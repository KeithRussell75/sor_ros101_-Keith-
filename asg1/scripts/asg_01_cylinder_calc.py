...
def calculate():
	if radius_found and radius_squared_found and height_found:
		msg = Cylinder() #creating a blank cylinder message
		msg.volume = pi * radius_squared * height #write to the vaiables in the class
		msg.suface_area = 2 * pi *(radius * height + radius_squared)
